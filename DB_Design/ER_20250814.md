...
erDiagram
  ...
  CATEGORY_MASTER ||--o{ PET_MASTER : "category_code"
  ...
  OPAM            ||--o{ CATEGORY_DATA_LINK : "参照(OPAM_ID)"
  CATEGORY_MASTER ||--o{ CATEGORY_DATA_LINK : "参照(category_code)"
  GMAPM           ||--o{ CATEGORY_DATA_LINK : "参照(GMAPM_ID)"
  ...
  CATEGORY_DATA_LINK     ||..o{ RORO_RECOMMENDATION_LOG : "based_on(論理参照)"
  OPAM                   ||..o{ RORO_RECOMMENDATION_LOG : "冗長参照(任意)"
  GMAPM                  ||..o{ RORO_RECOMMENDATION_LOG : "冗長参照(任意)"
