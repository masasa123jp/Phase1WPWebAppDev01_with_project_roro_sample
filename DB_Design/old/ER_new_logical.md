...
erDiagram
  ...
  RORO_CUSTOMER["顧客 / RORO_CUSTOMER"] {
    ...
    BIGINT default_pet_id FK "既定ペットID / Default Pet ID"
    DATETIME created_at "作成日時 / Created At"
    DATETIME updated_at "更新日時 / Updated At"
  }

  RORO_USER_LINK_WP["顧客とWPユーザーの紐付け / RORO_USER_LINK_WP"] {
  ...
  RORO_FACILITY["施設 / RORO_FACILITY"] {
    ...
    POINT facility_pt "生成列: 緯度経度ポイント / Generated LatLng Point"
  }
  ...
  RORO_MAP_FAVORITE["地図お気に入り / RORO_MAP_FAVORITE"] {
    ...
    DECIMAL lat "緯度 / Latitude"
    DECIMAL lng "経度 / Longitude"
    POINT place_pt "生成列: 緯度経度ポイント / Generated LatLng Point"
    TIMESTAMP created_at "作成日時 / Created At"
  }
  ...
  RORO_CUSTOMER       ||--o{ RORO_AI_CONVERSATION : "会話開始 / starts"
  ...
  RORO_CUSTOMER ||--|| RORO_USER_LINK_WP : "WPと連携 / links_to_wp"
  WP_USERS      ||--|| RORO_USER_LINK_WP : "顧客に連携 / links_to_customer"
