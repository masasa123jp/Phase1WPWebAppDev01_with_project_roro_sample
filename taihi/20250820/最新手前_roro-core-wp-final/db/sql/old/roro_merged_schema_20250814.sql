-- =====================================================================
-- RORO 統合スキーマ & マイグレーション（自動生成）
-- 生成日時: 2025-08-13 15:57:04
-- 内容:
--   1) ベーススキーマ: schema-roro_modified_v3.sql
--   2) 追加マイグレーション: roro_schema_migration_20250814.sql
-- 対象: MariaDB / MySQL 8+（XServer MariaDB 10.5+想定）
-- 備考: それぞれのスクリプトは IF EXISTS/IF NOT EXISTS を多用しており、
--       再実行可能性に配慮されています。本統合ファイルは順次実行を想定。
-- =====================================================================
