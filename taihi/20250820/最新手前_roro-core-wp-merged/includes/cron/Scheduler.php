...
class Scheduler {
	...
	public static function register_event(): void {
		if ( ! wp_next_scheduled( self::HOOK_WEEKLY_PUSH ) ) {
            // Schedule weekly push notifications for 4:00 on the next Monday (JST equivalent).
            wp_schedule_event( strtotime( 'next monday 04:00' ), 'weekly', self::HOOK_WEEKLY_PUSH );
		}
	}
