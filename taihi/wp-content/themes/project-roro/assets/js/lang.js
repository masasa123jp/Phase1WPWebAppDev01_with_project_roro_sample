...
const translations = {
  ja: {
    ...
    label_password_confirm: 'パスワード（確認）',
    pet_info: 'ペット情報',
    add_pet: 'ペットを追加',
    save: '保存',
    logout: 'ログアウト',
    ...
    // --- Sign up page & general messages ---
    ,signup_title: '新規登録'
    ,label_pet_type: 'ペットの種類'
    ,label_pet_name: 'ペットのお名前'
    ,label_pet_age: 'ペットの年齢'
    ,dog: '犬'
    ,cat: '猫'
    ,puppy: '子犬/子猫 (1歳未満)'
    ,adult: '成犬/成猫 (1〜7歳)'
    ,senior: 'シニア犬/シニア猫 (7歳以上)'
    ,signup_submit: '新規登録'
    ...
    ,go_login: 'こちらからログイン'
    // バリデーションメッセージ
    ,error_required_login_fields: 'メールアドレスとパスワードを入力してください'
    ,error_invalid_email_format: '有効なメールアドレスを入力してください'
    ,error_user_mismatch: 'ユーザー情報が一致しません。メールアドレスまたはパスワードが誤っています。'
    ,error_required_signup_fields: '名前、メールアドレス、パスワードは必須です'
  ...
  en: {
    ...
    ,label_pet_type: 'Pet Type'
    ,label_pet_name: 'Pet Name'
    ,label_pet_age: 'Pet Age'
    ,dog: 'Dog'
    ,cat: 'Cat'
    ,puppy: 'Puppy/Kitten (under 1 year)'
    ,adult: 'Adult Dog/Cat (1-7 years)'
    ,senior: 'Senior Dog/Cat (7+ years)'
    ,signup_submit: 'Sign Up'
    ,signup_google: 'Sign up with Google'
    ,signup_line: 'Sign up with LINE'
    ,have_account: 'Already have an account?'
    ,go_login: 'Login here'
    ,error_required_login_fields: 'Please enter your email and password'
    ,error_invalid_email_format: 'Please enter a valid email address'
    ,error_user_mismatch: 'User not found or incorrect password.'
    ,error_required_signup_fields: 'Name, email, and password are required'
  ...
  zh: {
    ...
    ,signup_line: '使用 LINE 注册'
    ,have_account: '已有账号？'
    ,go_login: '点击这里登录'
    ,error_required_login_fields: '请输入电子邮件和密码'
    ,error_invalid_email_format: '请输入有效的电子邮件地址'
    ,error_user_mismatch: '用户信息不匹配，邮件或密码错误。'
    ,error_required_signup_fields: '姓名、电子邮件和密码为必填项'
    ,error_password_mismatch: '密码不一致'
  },
  ko: {
    nav_map: '지도',
    nav_ai: 'AI',
    ...
    // --- Sign up page & general messages ---
    ,signup_title: '회원 가입'
    ,label_pet_type: '반려동물 종류'
    ,label_pet_name: '반려동물 이름'
    ,label_pet_age: '반려동물 나이'
    ,dog: '개'
    ,cat: '고양이'
    ,puppy: '강아지/새끼 고양이 (1세 미만)'
    ,adult: '성견/성묘 (1~7세)'
    ,senior: '노견/노묘 (7세 이상)'
    ,signup_submit: '가입하기'
    ...
    ,go_login: '여기에서 로그인'
    ,error_required_login_fields: '이메일과 비밀번호를 입력하세요'
    ,error_invalid_email_format: '유효한 이메일 주소를 입력하세요'
    ,error_user_mismatch: '사용자 정보가 일치하지 않습니다. 이메일 또는 비밀번호가 잘못되었습니다.'
    ,error_required_signup_fields: '이름, 이메일, 비밀번호는 필수입니다'
