...
const translations = {
  ja: {
    ...
    ai_intro: '以下のウィンドウでは、外部AIアシスタントと対話することができます。ペットのイベント情報やおすすめスポットなど、気になることを気軽に質問してみましょう。',
  ...
  en: {
    ...
    ai_intro: 'You can chat with our external AI assistant in the window below. Feel free to ask about pet events and recommended spots.',
  ...
  zh: {
    ...
    ai_intro: '您可以在下方的窗口与外部AI助手聊天，咨询宠物活动和推荐地点等。',
  ...
  ko: {
    ...
    ai_intro: '아래 창에서 외부 AI 어시스턴트와 대화할 수 있습니다. 반려동물 이벤트와 추천 장소에 대해 문의하세요.',
