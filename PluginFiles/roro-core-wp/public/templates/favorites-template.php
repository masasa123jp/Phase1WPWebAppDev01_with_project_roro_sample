...
<main id="favorites-container">
  <ul id="favorites-list" class="panel list"></ul>
...
<nav class="bottom-nav">
  ...
  <a href="/favorites" class="nav-item active"><img src="<?= esc_url(RORO_CORE_WP_URL.'assets/images/icon_favorite.png') ?>" alt="お気に入り" /><span data-i18n-key="nav_favorites">お気に入り</span></a>
