...
// Include helper functions.  These functions cannot be autoloaded
// through the PSR-4 autoloader because they live in the global
// namespace.  Loading them here makes the image helper available
// before any shortcodes or templates need it.
...
function roro_core_load_textdomain() {
    // Load translations for the plugin.  We use the text domain
    // `roro-core` to match the provided .pot and .po files in the
    // languages directory.  Developers adding new strings should use
    // this domain.
...
function roro_core_init() {
    ...
    // respectively.  Instantiating them here ensures the REST routes
    ...
    // RoroCore\Shortcode and is autoloaded via PSR-4.
